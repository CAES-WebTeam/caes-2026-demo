...
// Collaborators, Centers & Institutes, College Administration, Extension, Labs &
// Programs, Research & Education Centers, Support Units), and Locations are all
...
const PROGRAM = { "4H": "4-H", "ANR": "Agriculture & Natural Resources", "FACS": "Family & Consumer Sciences", "Support": "Support", "Admin": "Administration" };
...
const RAW = [
  ...
  ["Jennifer H Waldeck", "Professor and Department Head", "Department Head", "Agricultural Leadership, Education & Communication", "Admin", 2, "", "https://secure.caes.uga.edu/personnel/photos/2022_JenniferWaldeck1.jpg"],
  ...
  ["Connie J Rogers", "Department Head & Professor", "Department Head", "Family & Consumer Sciences", "FACS", 2, "", "https://secure.caes.uga.edu/personnel/photos/2023_ConnieRogers.jpg"],
  ...
  ["Allisen Penn", "FACS Associate Dean for Extension and Outreach", "Associate Dean", "Family & Consumer Sciences", "FACS", 2, "", "https://secure.caes.uga.edu/personnel/photos/2019_AllisenPenn.jpg"],
  ...
  ["Francis Fluharty", "Department Head Academic", "Department Head", "Animal & Dairy Science", "Admin", 2, "Animal Production; Food Sciences; Agriculture, Land and Farm Management; Veterinary Sciences", "https://secure.caes.uga.edu/personnel/photos/2022_FrancisFluharty.jpg"],
  ["April Few-Demo", "Dept Chair / Head Ac", "Department Head", "Family & Consumer Sciences", "FACS", 2, "", "https://secure.caes.uga.edu/personnel/photos/2022_AprilFew-Demo.jpg"],
  ...
  ["Swarnankur Chatterjee", "Department Head and Bluerock Professor of Financial Planning", "Department Head", "Family & Consumer Sciences", "FACS", 2, "Banking, Finance and Investment; Applied Economics; Marketing; Other Economics; Accounting, Auditing and Accountability; Business and Management", "https://secure.caes.uga.edu/personnel/photos/2021_SwarnankurChatterjee1.jpg"],
  ["Todd Applegate", "Assistant Dean for International Programs; Department Head and R. Harold & Patsy Harrison Distinguished Chair in Poultry Science", "Assistant Dean", "Poultry Science", "Admin", 2, "Animal Production; Animal Nutrition", "https://secure.caes.uga.edu/personnel/photos/2020_ToddApplegate.jpg"],
  ["Daniel L. Jackson", "Laboratory Manager", "State Staff", "Agricultural & Environmental Services Lab (AESL)", "Support", 2, "Agronomy; Environmental Sciences; Food Sciences; Analytical Chemistry; Horticultural Production; Crop and Pasture Production", "https://secure.caes.uga.edu/personnel/photos/2015_DJackson.jpg"],
  ...
  ["Gajanan S Bhat", "Dept Chair / Head Ac", "", "Family & Consumer Sciences", "", 2, "Manufacturing Engineering; Materials Engineering; Other Chemical Sciences; Mechanical Engineering; Polymers and Plastics; Textile Technology", "https://secure.caes.uga.edu/personnel/photos/2025_GajananBhat.jpg"],
  ["Eric D. Rubenstein", "Associate Professor", "State Faculty - Tenure Track", "Agricultural Leadership, Education & Communication", "Support", 2, "Curriculum and Pedagogy; Education Systems", "https://secure.caes.uga.edu/personnel/photos/2017_EricRubenstein.jpg"],
  ["Melanie Biersmith", "State 4-H Leader", "State Faculty - Public Service Track", "4-H & Youth", "4H", 2, "Information Systems; Psychology; Cognitive Sciences", "https://secure.caes.uga.edu/personnel/photos/2024_MelanieBiersmith.jpg"],
  ["Romdhane Rekaya", "Professor", "State Faculty - Tenure Track", "Animal & Dairy Science", "ANR", 2, "Animal Production; Food Sciences; Microbiology; Genetics", "https://secure.caes.uga.edu/personnel/photos/2019_RomdhaneRekaya.jpg"],
  ["Ellen McCullough", "Assistant Professor", "State Faculty - Tenure Track", "Agricultural & Applied Economics", "ANR", 2, "Agriculture, Land and Farm Management; Food Sciences; Policy and Administration", "https://secure.caes.uga.edu/personnel/photos/2019_EllenMcCullough.jpg"],
  ...
  ["Mohamed Mergoum", "Georgia Seed Development UGAF Professor in Wheat Breeding and Genetics (Plant Breeding, Genetics, & Genomics)", "State Faculty - Tenure Track", "Crop & Soil Sciences", "Support", 3, "Crop and Pasture Production; Plant Biology; Genetics; Food Sciences", "https://secure.caes.uga.edu/personnel/photos/2020_MohamedMergoum.jpg"],
  ["Kylee Jo Duberstein", "Professor", "State Faculty - Tenure Track", "Animal & Dairy Science", "ANR", 2, "Veterinary Sciences; Neurosciences; Clinical Sciences; Cardiorespiratory Medicine and Haematology; Animal Production; Psychology", "https://secure.caes.uga.edu/personnel/photos/2019_KyleeDuberstein.jpg"],
  ["Jeffrey L. Jordan", "Emeritus Faculty & Director of Sustainable Agriculture Research and Education (SARE) Program-Southern Region", "Emeritus Faculty", "Agricultural & Applied Economics", "ANR", 3, "Applied Economics; Horticultural Production; Environmental Engineering; Food Sciences; Environmental Science and Management; Chemical Engineering", "https://secure.caes.uga.edu/personnel/photos/2024_JeffreyJordan.jpg"],
  ...
  ["Mussie Habteselassie", "Professor of Soil Microbiology", "State Faculty - Tenure Track", "Crop & Soil Sciences", "ANR", 3, "Microbiology; Food Sciences; Horticultural Production; Animal Production; Environmental Science and Management; Soil Sciences", "https://secure.caes.uga.edu/personnel/photos/2016_MussieHabteselassie.jpg"],
  ["Sha Tao", "Associate Professor", "State Faculty - Tenure Track", "Animal & Dairy Science", "ANR", 2, "Animal Production; Food Sciences", "https://secure.caes.uga.edu/personnel/photos/2019_ShaTao.jpg"],
  ...
  ["Sammy E. Aggrey", "Distinguished Research Professor | Richard B. Russell Endowed Chair & Professor", "State Faculty - Tenure Track", "Poultry Science", "ANR", 2, "Animal Production; Food Sciences; Microbiology; Genetics; Zoology; Veterinary Sciences", "https://secure.caes.uga.edu/personnel/photos/2020_SamuelAggrey.jpg"],
  ["Lenny Wells", "Professor & Pecan Extension Specialist; Emphasis: Pecans", "State Faculty - Tenure Track", "Horticulture", "ANR", 1, "Horticultural Production; Zoology; Plant Biology; Crop and Pasture Production", "https://secure.caes.uga.edu/personnel/photos/2022_MarvinWells.jpg"],
  ["Nandita Gaur", "Assistant Professor - Soil Physics", "State Faculty - Tenure Track", "Crop & Soil Sciences", "ANR", 2, "Physical Geography and Environmental Geoscience; Civil Engineering; Environmental Engineering; Applied Economics; Crop and Pasture Production", "https://secure.caes.uga.edu/personnel/photos/2020_NanditaGaur.jpg"],
  ["Clint Waltz", "Extension Specialist - Turfgrass", "State Faculty - Tenure Track", "Crop & Soil Sciences", "ANR", 3, "Horticultural Production; Crop and Pasture Production; Plant Biology; Zoology; Education Systems", "https://secure.caes.uga.edu/personnel/photos/2025_FreddieWaltz.jpg"],
  ...
  ["Lisa Baxter", "Associate Professor and State Forage Specialist", "State Faculty - Tenure Track", "Crop & Soil Sciences", "ANR", 1, "Crop and Pasture Production; Horticultural Production; Civil Engineering; Environmental Science and Management; Plant Biology; Zoology", "https://secure.caes.uga.edu/personnel/photos/2023_LisaBaxter1.jpg"],
  ["Patrick J. Conner", "Professor & Tifton REI Coordinator; Emphasis: Pecan & muscadine breeding", "State Faculty - Tenure Track", "Horticulture", "ANR", 1, "Horticultural Production; Crop and Pasture Production; Plant Biology", "https://secure.caes.uga.edu/personnel/photos/2017_PatrickConner.jpg"],
  ["Henry Y. Sintim", "Associate Professor", "State Faculty - Tenure Track", "Crop & Soil Sciences", "ANR", 1, "Crop and Pasture Production; Horticultural Production; Other Agricultural and Veterinary Sciences; Civil Engineering; Environmental Engineering; Materials Engineering", "https://secure.caes.uga.edu/personnel/photos/2019_HenrySintim1.jpg"],
];
...
const DEPT_GROUPS = [
  { key: "acad", label: "Academic Departments", members: [
    "Agricultural & Applied Economics", "Agricultural Leadership, Education & Communication",
    "Animal & Dairy Science", "Crop & Soil Sciences", "Entomology",
    "Food Science & Technology", "Horticulture", "Plant Pathology", "Poultry Science",
  ] },
  ...
  { key: "centers", label: "Centers & Institutes", members: [
    "Center for Agribusiness and Economic Development (CAED)", "Center for Food Safety",
    "Center for Invasive Species and Ecosystem Health", "Food Product Innovation & Commercialization Center",
  ...
  { key: "extension", label: "Extension", members: [
    "4-H & Youth", "Family & Consumer Sciences", "Northeast District",
    "Northwest District", "Southeast District", "Southwest District",
  ] },
  { key: "labs", label: "Labs & Programs", members: [
    "Agricultural & Environmental Services Lab (AESL)", "Animal Waste Awareness in Research and Extension",
  ...
  { key: "recenters", label: "Research & Education Centers", members: [
    ...
    "Southwest Research and Education Center", "UGA Grand Farm", "Vidalia Onion & Vegetable Research Center",
  ] },
  { key: "support", label: "Support Units", members: [
    "Academic and Student Affairs - Griffin", "Business Office - Griffin", "CAES - Contracts & Grants",
